...
export class DefinitionProvider {
    ...
    private collect_local_macro_scope_locations(
        ...
        const should_include_candidate = (macro_symbol: MacroSymbol): boolean => {
            ...
            // Prefer definition_line when present; directive-created and
            // expanded symbols may decouple the source location from the line
            // at which diagnostics should consider the symbol visible.
