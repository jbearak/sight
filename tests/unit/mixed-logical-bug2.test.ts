...
describe('MixedLogicalOperatorAnalyzer False Negative Test', () => {
    it('detects mixed operators across a function comma', () => {
        const analyzer = new MixedLogicalOperatorAnalyzer();
        const doc = create_document_state('display x & min(a, b) | y');
