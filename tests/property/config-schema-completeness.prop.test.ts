...
const EXPECTED_CONFIG_FIELDS: ConfigFieldSpec[] = [
    ...
    {
        path: 'sight.diagnostics.severity.spacedCompoundOperator',
        type: 'string',
        enum_values: ['error', 'warning', 'information', 'hint', 'off'],
    },
    {
    ...
    {
        path: 'sight.diagnostics.severity.cStyleLogicalInControlFlow',
        type: 'string',
        enum_values: ['error', 'warning', 'information', 'hint', 'off'],
    },
    {
        path: 'sight.diagnostics.severity.mixedLogicalOperators',
        type: 'string',
        enum_values: ['error', 'warning', 'information', 'hint', 'off'],
    },
    {
        path: 'sight.diagnostics.severity.chainedComparison',
        type: 'string',
        enum_values: ['error', 'warning', 'information', 'hint', 'off'],
    },
    {
        path: 'sight.diagnostics.severity.literalMacroAdjacency',
        type: 'string',
        enum_values: ['error', 'warning', 'information', 'hint', 'off'],
    },
    {
    ...
    it('should not have orphaned settings in package.json', () => {
        ...
        const the_setting_keys = Object.keys(config_properties).filter(
            (key) => !key.startsWith('sight.sendToStata.')
                ...
                && !key.startsWith('sight.depthColors.')
        );
        const setting_arb = fc.constantFrom(...the_setting_keys);
