...
describe('Formatter Comment Normalization Property Tests', () => {
  ...
  it('should normalize comments to slash style when enabled', () => {
    fc.assert(
      fc.property(
        fc.array(
          fc.record({
  ...
  // when enabled
  // Validates: Requirements 2.4, 3.6, 4.7
  it('should preserve comment content during normalization', () => {
    fc.assert(
      fc.property(
        fc.array(
          fc.record({
  ...
  // when enabled
  // Validates: Requirements 2.4, 3.6, 4.7
  it('should normalize comments to star style when configured', () => {
    fc.assert(
      fc.property(
        fc.array(
          fc.record({
  ...
  // when enabled
  // Validates: Requirements 2.4, 3.6, 4.7
  it('should normalize comments to block style when configured', () => {
    fc.assert(
      fc.property(
        fc.array(
          fc.record({
  ...
  // when enabled
  // Validates: Requirements 2.4, 3.6, 4.7
  it('should produce different result when normalization enabled vs disabled', () => {
    fc.assert(
      fc.property(
        fc.array(
          fc.record({
