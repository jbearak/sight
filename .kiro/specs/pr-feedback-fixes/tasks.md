...
- [ ] 3.1 Write property test for frame prefix parsing
  - **Property 2: Frame prefix parsing semantics**
  - **Validates: Requirements 3.1, 3.2**

- [ ] 3.2 Write property test for by-prefix preservation
  - **Property 3: By-prefix parsing preservation**
  - **Validates: Requirements 3.3, 3.5**

- [ ] 4. Update test files to use shared utilities
...
- [ ] 4.1 Write property test for shared utility consistency
  - **Property 4: Shared utility consistency**
  - **Validates: Requirements 4.4**

- [ ] 4.2 Write integration tests for backward compatibility
