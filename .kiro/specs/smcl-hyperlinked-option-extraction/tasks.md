...
- [x] 1. Add hyperlinked argument pattern support to parse_option_pattern()
  - [x] 1.1 Add regex pattern for `{opt[h] abbrev:rest:(content)}` format
  ...
  - [x] 1.2 Add regex pattern for `{opt[h] name:(content)}` format
...
- [x] 2. Add unit tests for hyperlinked argument patterns
  - [x] 2.1 Add unit tests for specific hyperlinked patterns in smcl-extractor.test.ts
  ...
  - [x] 2.2 Add property test for hyperlinked argument extraction (simple name)
  ...
  - [x] 2.3 Add property test for hyperlinked argument extraction (with abbreviation)
...
- [x] 3. Checkpoint - Verify implementation and tests
  - Ensure all tests pass, ask the user if questions arise.
  - Run existing property tests to verify backward compatibility (Property 3)
  - _Requirements: 2.1, 2.2, 2.3, 2.4, 2.5, 2.6_

- [x] 4. Add integration test for regress.sthlp
  - [x] 4.1 Add test with mock regress.sthlp content containing vce option
