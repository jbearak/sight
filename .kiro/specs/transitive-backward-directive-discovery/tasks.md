...
- [x] 1. Register backward directive dependencies when caching files
  - [x] 1.1 Add call to register dependencies in `get_or_parse_file_with_cache`
  ...
  - [x] 1.2 Write property test for cache population
    - **Property 1: Cache Population Registers Dependencies**
    - **Validates: Requirements 2.1**

- [x] 2. Clear backward directive dependencies on cache invalidation
  - [x] 2.1 Update `invalidate_file_cache` to clear backward directive dependencies
...
- [x] 4. Integration testing
  - [x] 4.1 Write integration test for transitive discovery from cache
