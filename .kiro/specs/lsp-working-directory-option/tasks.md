...
- [ ] 1. Implement LSP Server Handler
  - [ ] 1.1 Add custom request handler for `sight/getWorkingDirectory`
  ...
  - [ ] 1.2 Wire up custom request in server factory
  ...
  - [ ] 1.3 Write property test for server response correctness
    - **Property 1: Server Response Correctness**
    - **Validates: Requirements 2.2, 2.3, 2.4, 2.5, 2.6**

- [ ] 2. Update Client Configuration
  - [ ] 2.1 Add "lsp" enum value to package.json
...
- [ ] 3. Implement Client-Side LSP Integration
  - [ ] 3.1 Update type definitions for working directory option
  ...
  - [ ] 3.2 Add LSP client request function
  ...
  - [ ] 3.3 Update content preparation to handle "lsp" option
  ...
  - [ ] 3.4 Write property test for content transformation
...
- [ ] 4. Update CD Menu Visibility Logic
  - [ ] 4.1 Update CD context for "lsp" option
