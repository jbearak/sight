...
- [x] 1. Implement path escaping utility
  - [x] 1.1 Create `escape_path_for_stata` function in `client/src/send-to-stata/cd-commands.ts`
  ...
  - [x] 1.2 Write property test for path escaping
...
- [x] 2. Implement context variable management
  - [x] 2.1 Create context initialization and update functions in `client/src/send-to-stata/cd-commands.ts`
...
- [x] 3. Implement CD command handlers
  ...
  - [x] 3.2 Create `execute_cd_command` function
  ...
  - [x] 3.3 Write property test for CD command generation
...
- [x] 5. Register commands and integrate with extension
  - [x] 5.1 Create `register_cd_commands` function
  ...
  - [x] 5.2 Update `client/src/send-to-stata/index.ts` exports
    - Export `initialize_cd_context`
    - Export `register_cd_commands`
    - _Requirements: 5.2_
  
  - [x] 5.3 Update `client/src/extension.ts` to initialize CD features
...
- [x] 6. Update package.json with commands and menus
  - [x] 6.1 Add command definitions to `client/package.json`
  ...
  - [x] 6.2 Add menu items to `sight.sendToStata` submenu
  ...
  - [x] 6.3 Add menu items to `sight.sendToStata.terminal` submenu
