...
- [ ] 5. Update server handlers to pass config to formatter
  - [ ] 5.1 Update formatting handler in `src/server-handlers.ts`
    - Pass StataLSPConfig to CodeFormatter.format()
    - _Requirements: 1.1, 2.4_
  - [ ] 5.2 Update format_with_comment_normalization if needed
    - Ensure mode is respected when comment normalization is enabled
    - _Requirements: 1.3, 1.4_

- [ ] 6. Add VS Code extension setting
  - [ ] 6.1 Update `client/package.json` contributes.configuration
  ...
  - [ ] 6.2 Update extension to read and pass setting to server
