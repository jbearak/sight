...
- [x] 1. Update schedule_caller_revalidation to include backward directive dependents
  - [x] 1.1 Modify `schedule_caller_revalidation` in server-factory.ts
...
- [x] 3. Integration testing
  - [x] 3.1 Write integration test for forward call to backward directive propagation
